...
gran cantidad de librerías o packages ( [se peden ver en este
...
para ello hay que hacer referencia a ese elemento pero con signo
...
*order* que nos devuelve el indice de los elementos pero ordenados.
    ...
    #Observamos que el segundo valor es el mínimo, después viene el cuarto valor, etc.
    #Ahora utilizo las posiciones dadas anteriormente para ordenar el vector
...
![](Primeros_paso_R_files/figure-markdown_strict/unnamed-chunk-16-1.png)
    ...
    # Lo mismos pero una distribución normal(2,0.2)
